{
  description = "Python dev shell with Python 3.10, pyodbc, pycairo, FreeTDS";
  ...
  in {
    devShells.${system}.default = pkgs.mkShell {
      ...
      shellHook = ''
        ...
        source $HOME/.dotfiles/nix-shells/python-azsqldb-shell/.env
        ...
        echo ""
        echo "🎊 Python Nix environment setup complete! 🚀"
        echo "🎯 Ready for python development with FreeTDS support!"

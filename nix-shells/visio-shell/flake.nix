  ...
  in {
    devShells.${system}.default = pkgs.mkShell {
      ...
      shellHook = ''
        ...
        source $HOME/.dotfiles/nix-shells/visio-shell/.env

        echo "🎉 Visio! Nix shell initializing... ✨"
        ...
        echo "🌐 ODBC environment variables configured, ODBCSYSINI : $ODBCSYSINI"
        ...
        echo ""
        echo "🎊 Django Nix environment setup complete! 🚀"
